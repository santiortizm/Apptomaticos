...
class ChargingPeriod extends StatefulWidget {
  const ChargingPeriod({super.key});

  @override
  State<ChargingPeriod> createState() => _ChargingPeriodState();
}

class _ChargingPeriodState extends State<ChargingPeriod> {
